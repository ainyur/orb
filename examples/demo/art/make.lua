...
-- and red, sampled from the Ainyur portrait.
local dir = "examples/demo/art/"

local BLACK    = Color{r=0,   g=0,   b=0}
local INK      = Color{r=18,  g=18,  b=18}   -- background
...
local function player_file()
    ...
    -- a white 8x8 body; the second frame is identical for now, so the walk
    -- animation exists without the body jumping about
